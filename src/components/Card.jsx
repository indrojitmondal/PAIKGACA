...
const Card = ({ brand }) => {
    ...
    return (
        <div className='lg:w-10/12 border border-green-500 grid grid-cols-2  p-4  gap-4 lg:justify-between  items-center  mx-auto my-8'>
            <div className="left">
            ...
            <div className="middle flex  justify-between">
                ...
                <div>
                    ...
                    <Link  className='btn mt-3'>View Details</Link>
